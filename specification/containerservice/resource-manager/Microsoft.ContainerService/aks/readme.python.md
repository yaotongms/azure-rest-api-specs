...
### Tag: package-2024-06 and python

These settings apply only when `--tag=package-2024-06 --python` is specified on the command line.
Please also specify `--python-sdks-folder=<path to the root directory of your azure-sdk-for-python clone>`.

``` yaml $(tag) == 'package-2024-06' && $(python)
namespace: azure.mgmt.containerservice.v2024_06_01
output-folder: $(python-sdks-folder)/containerservice/azure-mgmt-containerservice/azure/mgmt/containerservice/v2024_06_01
```
